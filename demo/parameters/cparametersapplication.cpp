#include "cparametersapplication.h"
#include "cparametersframelistener.h"
//------------------------------------------------------------------------------------------
using namespace rtc;
using namespace Ogre;
//------------------------------------------------------------------------------------------
CParametersApplication::CParametersApplication()
: CRtcApplication()
...
void CParametersApplication::createFrameListener()
{
    mpFrameListener= new CParametersFrameListener(*mpSceneMgr, *mpWindow);
    mpRoot->addFrameListener(mpFrameListener);
}

//------------------------------------------------------------------------------------------

void CParametersApplication::createScene()
{
    createFrameListener();
